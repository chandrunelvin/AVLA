      ...
      <div className="group/grid mt-[28px] grid grid-cols-1 gap-[14px] min-[900px]:mt-[40px] min-[900px]:grid-cols-3 min-[900px]:gap-[14px]">
        {certifications.map((cert) => (
          ...
          >
            ...
            {/* Title */}
            <p
              className={`absolute top-[113px] md:top-[101px] left-[20px] w-[120px] md:w-[164px] right-auto md:right-[36%] text-[18px] md:text-[20px] font-normal leading-[23.88px] capitalize transition-colors duration-300 ${
                cert.active
