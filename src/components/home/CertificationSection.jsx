  ...
  return (
    <section className="mx-auto mt-[50px] w-full rounded-[20px] bg-[#Ffffff] px-[8px] pb-[8px] pt-[36px] sm:px-[42px] sm:pb-[52px] sm:pt-[50px]">
      ...
      <div className="mt-[18px] flex flex-col gap-[14px] text-center sm:mt-[22px] sm:flex-row sm:items-start sm:justify-between sm:gap-0 sm:text-left">
        <h2 className="text-[28px] font-normal leading-[34px] text-[#111111] sm:w-[527px] sm:max-w-none sm:text-[36px] sm:leading-[44px]">
          Our Certifications &amp; Global Compliance Standards
        </h2>
        <p className="text-[16px] font-normal leading-[22px] text-[#6d6d6ecc] sm:mt-[6px] sm:w-[545px] sm:max-w-none sm:text-[16px] sm:leading-[24px]">
      ...
      {/* Cards grid */}
      <div className="group/grid mt-[28px] grid grid-cols-1 gap-[14px] overflow-hidden sm:mt-[40px] sm:grid-cols-3">
        {certifications.map((cert) => (
          <div
            ...
            className={`group relative h-[190px] rounded-[20px] cursor-pointer transition-colors duration-300 sm:h-[180px] sm:w-[437px] sm:rounded-[20.47px] ${
              cert.active
                ? 'bg-[#0161FE] group-hover/grid:bg-[#F6F7F9] hover:!bg-[#0161FE]'
                : 'bg-[#F6F7F9] hover:bg-[#0161FE]'
            }`}
          >
            ...
            <div
              className={`absolute left-[20px] top-[20px] flex h-[40px] w-[40px] items-center justify-center rounded-full transition-colors duration-300 ${
                cert.active
                  ? 'bg-white/20 group-hover/grid:bg-[#0161FE] group-hover:!bg-white/20'
                  : 'bg-[#0161FE] group-hover:bg-white/20'
              }`}
            >
            ...
            {/* Title — bottom left */}
            <p
              className={`absolute bottom-[55px] left-[20px] w-[113px] sm:w-auto sm:right-[160px] text-[20px] font-normal leading-[26px] transition-colors duration-300 ${
                cert.active
            ...
            {/* Certificate card */}
            <div
              className={`absolute right-[10px] top-[10px] h-[163px] w-[148px] sm:h-[163px] sm:w-[148px] rounded-[16px] shadow-md transition-colors duration-300 ${
                cert.active
                  ? 'bg-[rgba(130,170,249,1.00)] group-hover/grid:bg-[#C5C6C7] group-hover:!bg-[rgba(130,170,249,1.00)]'
                  : 'bg-[#C5C6C7] group-hover:bg-[rgba(130,170,249,1.00)]'
              }`}
            >
              <img
                src="/assets/images/home/certificate.png"
                alt={cert.title}
                className="absolute -left-[8px] top-[6px] h-[147px] w-[192px] rounded-[5px]"
                loading="lazy"
              />
            </div>
          </div>
